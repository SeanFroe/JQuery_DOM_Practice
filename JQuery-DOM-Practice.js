1; // 1. When the DOM is ready, console.log the message
...
$(function () {
  ...
  //   (this class is defined inside of the style tag in the head). see(index.html article, img)
  ...
  $("aside")
    .empty()
    .append($("<p>", { text: "Sorry about the lists existence." }));
